    ...
    try:
        ...
        while isLoop is False:
            ...
            if result_my_server_read == 'start':
                ...
                print(nowTime)
                full_path = "c:\\my_games\\nightcrow\\data_nc\\imgs\\monitor\\unreal_error_1.png"
                ...
                full_path = "c:\\my_games\\nightcrow\\data_nc\\imgs\\monitor\\closewithoutsending.PNG"
                img_array = np.fromfile(full_path, np.uint8)
                img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                imgs_ = imgs_set(0, 700, 960, 850, "one", img)
                if imgs_ is not None:
                ...
                full_path = "c:\\my_games\\nightcrow\\data_nc\\imgs\\monitor\\unreal_error_2.png"
                img_array = np.fromfile(full_path, np.uint8)
                img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                ...
                full_path = "c:\\my_games\\nightcrow\\data_nc\\imgs\\monitor\\sendandrestart.PNG"
                img_array = np.fromfile(full_path, np.uint8)
                img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                imgs_ = imgs_set(0, 700, 960, 850, "two", img)
                if imgs_ is not None:
